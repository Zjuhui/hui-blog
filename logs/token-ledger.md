...
这个文件用于记录每次完成组件、页面、文章或版本时的大致 token 使用量。它可以作为博客长期彩蛋，也可以作为 AI-assisted workflow 的透明记录。

| Date | Version | Scope | Input Tokens | Output Tokens | Notes |
| --- | --- | --- | ---: | ---: | --- |
...
| 2026-06-08 | v0.2-docs | Cross-computer update guide and v0.2 planning docs | TBD | TBD | Added build:pages script, update guide, v0.2 plan, Notion export |
